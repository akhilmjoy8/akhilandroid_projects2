...
public class Security_GoneOut_Fragment extends Fragment{

    public Security_GoneOut_Fragment() {
    ...
    private void returnStudent() {
        ...
        final StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_STUDENT_LEAVING, new Response.Listener<String>() {
            ...
            public void onResponse(String response1) {
                ...
                try {
                    ...
                    for (int i = 0; i < JSON_SIZE; i++) {
                        ...
                        SecurityOutpassData outpass = new SecurityOutpassData();
                ...
                SecurityCustomAdapter adapter = new SecurityCustomAdapter(getContext(),R.layout.security_outpass_lstview, securityArray);
